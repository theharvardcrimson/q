<?php
$DATABASE_HOST = $_ENV['Q_SCRAPER_DATABASE_HOST'];
$DATABASE_USER = $_ENV['Q_SCRAPER_DATABASE_USER'];
$DATABASE_PASSWORD = $_ENV['Q_SCRAPER_DATABASE_PASSWORD'];
$DATABASE_NAME = $_ENV['Q_SCRAPER_DATABASE_NAME'];
